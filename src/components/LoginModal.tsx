...
import { loginWithEmail, signupWithEmail, signInWithGoogle } from "@/services/firebaseAuth";
                  ...
                  <div className="p-7 space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <button
                        ...
                        disabled={isLoading}
                        className="border-2 border-gray-200 text-gray-700 font-semibold py-2.5 px-4 rounded-lg hover:border-orange-200 hover:bg-orange-50/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 group">
                        {isLoading ? (
